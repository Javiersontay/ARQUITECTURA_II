...
El pipeline configurado en `.github/workflows/deploy.yml` realiza:

1. Instalación de dependencias
2. Build del proyecto
3. Subida del contenido de `dist/` al bucket S3
4. Invalidación de caché en CloudFront

Se ejecuta automáticamente al hacer push a la rama `assignment-02`.
